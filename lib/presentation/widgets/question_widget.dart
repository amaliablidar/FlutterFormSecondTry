...
class QuestionWidget extends StatefulWidget {
  const QuestionWidget({Key? key, required this.question,required this.controller}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.question.answerType) {
      ...
      case AnswerType.double:
        ...
        return QuestionWidgetNumber(question: widget.question,controller:widget.controller);


      case AnswerType.string:
        return QuestionWidgetString(question: widget.question,controller: widget.controller);

      case AnswerType.bool:
        return QuestionWidgetBool(question: widget.question,controller: widget.controller);

      case AnswerType.multiple:
      case AnswerType.dropdown:
      default:
        return QuestionWidgetMultiple(question:widget.question,controller:widget.controller);
